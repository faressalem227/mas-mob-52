...
const MonthlyAssetMaintenanceLang = {
  ...
  Alternative1_Name: { 1: 'الوصف', 2: 'Description' },
  Alternative1_Cost: { 1: 'التكلفة', 2: 'Cost' },
  Alternative1_Age: { 1: 'العمر المتوقع', 2: 'Expected Age' },

  Alternative2: {
    1: 'بديل احلال وتجديد (احلال)',
    2: 'Rehabilitation and Renewal Alternative (Rehabilitation)',
  },
  Alternative2_Name: { 1: 'الوصف', 2: 'Description' },
  Alternative2_Cost: { 1: 'التكلفة', 2: 'Cost' },
  Alternative2_Age: { 1: 'العمر المتوقع', 2: 'Expected Age' },

  Alternative3: {
    1: 'بديل احلال وتجديد (استبدال)',
    2: 'Rehabilitation and Renewal Alternative (Replacement)',
  },
  Alternative3_Name: { 1: 'الوصف', 2: 'Description' },
  Alternative3_Cost: { 1: 'التكلفة', 2: 'Cost' },
  Alternative3_Age: { 1: 'العمر المتوقع', 2: 'Expected Age' },
};
