...
const CeneteralSchedulePreventiveMaintenance = () => {
  ...
  return (
    <MainLayout title={SchedulePreventiveMaintenanceLang.CenteralpageTitle[Lang]}>
      ...
      <View className="flex-1">
        <MainGrid
          ...
          UpdBody={{ DepartmentID, TargetTypeID: 3, IsSm: 1, ProcedureTypeID }}
          DelParam={[
...
export default CeneteralSchedulePreventiveMaintenance;
