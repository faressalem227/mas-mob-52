...
const PermitionsTypes = () => {
  ...
  return (
    <MainLayout title={ImportanceLang.PermitionsTypes[Lang]} className="">
        ...
        <View style={[styles.ImportanceGrid, { height: screenHeight }]}>
          <MainGrid
            tableHead={[
              ...
              {
                key: 'PermitTypeName',
                label: `${ImportanceLang.PermitTypeName[Lang]}`,
                type: '',
                input: 'true',
                visible: 'true',
              },
            ...
            mixedWidth={true}
            pk={'PermitTypeID'}
            spTrx={'api_ms_Permit_Types_Trx'}
            spIns={'api_ms_Permit_Types_Ins'}
            spUpd={'api_ms_Permit_Types_Upd'}
            spDel={'api_ms_Permit_Types_Del'}
            dynamicCode={{
              tbName: 'ms_Permit_Types',
              codeCol: 'PermitTypeCode',
            }}
            TrxParam={[
...
export default PermitionsTypes;
