...
const AssetsReports = ({ title, hasLeftComponent = false, onDrawerPress }) => {
    ...
    <View style={styles.container}>
            <MainLayout title={EmployeesReports.title[Lang]}>
                ...
                <MainGrid
                        const tableHead={[
                            ...
                            {
                                key: "ReportNo",
                                label: EmployeesReports.ReportGrid.ReportNo[Lang],
                                type: "number",
                                input: "true",
                                visible: "true",
                                width: 100
                                ...
                                key: "ReportTitle",
                                label: EmployeesReports.ReportGrid.ReportTitle[Lang],
                                input: "true",
                                visible: "true",
