...
const PreventiveMaintenanceServicesGrid = ({ LocationID, ProcedureID }) => {
			...
			const fetchData = async () => {
				...
				try {
					const response = await api.get(
						`/table?sp=api_ms_Procedures_Materials_Trx2&LocationID=${LocationID}&ProcedureID=${ProcedureID}`
					);
...
export default PreventiveMaintenanceServicesGrid;
...
//         await api.delete(
//           `/table?sp=api_ms_Procedures_Materials_Del&LocationID=5&ProcedureID=${ProcedureID}&ProcedureMaterilID=${rowData.ProcedureMaterilID}`
//         );
//         setModelLoader(false);
//         setRefetch((prev) => prev + 1);
//         setContractorsList((prevData) =>
