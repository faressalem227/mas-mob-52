...
const AssetMaintenanceGrid = ({ LocationID, SubLocationID, AssetID }) => {
		...
		const fetchData = async () => {
			...
			try {
				const response = await api.get(
					`/table?sp=api_Assets_plan&LocationID=5&AssetID=5317`
					// `/table?sp=api_Assets_plan&LocationID=${LocationID}&AssetID=${AssetID}`
				);
...
export default AssetMaintenanceGrid;
