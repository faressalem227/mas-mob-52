...
const FinancialAssetGrid = ({ DepartmentID, SubLocationID, AssetID }) => {
		...
		const fetchData = async () => {
			...
			try {
				const response = await api.get(
					`/table?sp=am_asset_financial_Trx&AssetID=${AssetID}`
				);
...
export default FinancialAssetGrid;
