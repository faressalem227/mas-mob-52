...
const ContractsGrid = ({ LocationID, WorkorderID }) => {
			...
			const fetchData = async () => {
				...
				try {
					const response = await api.get(
						`/table?sp=api_ms_Workorders_Contractors_List&LocationID=5&WorkorderID=6`
					);
	...
	//       setAssetList(HandleDropdownFormat(list, "AssetClassID", "AssetClassName"));
	//     } catch (err) {
